...
1  M Math    90    79    90    90    93
2  M Math    55    60    58    70    79
3  F Math    60    72    NA    80    77
4  M Math    66    48    89    70    72
5  F Math    63    60    54    55    61
6  M Math    61    48    63    60    83
7  M Math    40    42    83    80    56
8  M Math    50    44    11    60    71
9  M Math    75    80    93    90    85
```
...
> 这是一个自动化展示主成分分析的代码，主要用于展示，因为代码需要分类变量，后续可更新以适用于更广泛情况。

> 数据文件在Rplot仓库，https://github.com/xia0ya/Rplot